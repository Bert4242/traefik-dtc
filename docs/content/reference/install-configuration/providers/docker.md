...
| <a id="opt-providers-docker-labelPrefix" href="#opt-providers-docker-labelPrefix" title="#opt-providers-docker-labelPrefix">`providers.docker.labelPrefix`</a> | Defines the prefix used for Docker labels. Labels using this prefix are normalized to Traefik's default `traefik.` labels. |  "traefik."    | No   |
| <a id="opt-providers-docker-keepDefaultLabelPrefixLabelAsDefault" href="#opt-providers-docker-keepDefaultLabelPrefixLabelAsDefault" title="#opt-providers-docker-keepDefaultLabelPrefixLabelAsDefault">`providers.docker.keepDefaultLabelPrefixLabelAsDefault`</a> | Keeps labels using the default `traefik.` prefix when a custom `labelPrefix` is set. |  false    | No   |
